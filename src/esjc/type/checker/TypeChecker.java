...
public class TypeChecker {
  ...
  protected static class Visitor extends ASTVisitor {
     ...
     */
    public Map<ASTNode, Type> resultTypeMap;
     ...
     */
    protected ArrayType stringArrayType;
     ...
     */
    protected Visitor(final TypeFactory tf,
   ...
   */
  public static
  TypeTable check(final TypeFactory tf,
       final CompilationUnit cu,  final SymbolTable symbolTable)
      throws Error {
